...
const Aboutus = () => {
  return (
    <div className="flex lg:flex-row flex-col-reverse lg:my-20 my-10 justify-center relative">
      <div className="flex flex-col font-bold text-lg lg:text-3xl h-full">
        ...
        <div className="border-2 border-[#BE1E2D] w-fit self-end mt-8 mr-8 lg:mt-0 lg:mr-0">
          <img
            className="lg:h-[40rem] h-60 -ml-4 -mb-4 mt-4"
      ...
      <div className="flex flex-col justify-between mx-10 lg:ml-0 lg:items-end lg:gap-8 gap-4 lg:text-end lg:w-1/2">
        <div className="font-normal lg:text-6xl text-3xl">GIVE YOUR SPACE</div>
        <div className="font-normal lg:text-6xl text-3xl">
          {" "}
          AN <span className="text-[#BE1E2D] font-semibold">
            ASTONISHING
          </span>{" "}
        </div>
        <div className="font-normal lg:text-6xl text-3xl">FEEL.</div>
        <div className="lg:text-xl text-xs font-medium w-full lg:w-2/3 4xl:w-1/2">
        ...
        <div className="flex flex-row-reverse lg:flex-row items-end justify-between">
          <div className="flex lg:mr-16 lg:gap-8 font-light">
            <div className="flex flex-col text-center lg:text-sm text-xs w-20 items-center">
              <div className="text-lg lg:text-4xl font-semibold text-[#BE1E2D]">
