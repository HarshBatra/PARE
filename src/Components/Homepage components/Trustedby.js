...
const Trustedby = () => {
  return (
    <div className="bg-[#BE1E2D] lg:p-10 p-4 justify-around align-middle items-center relative flex lg:h-52 h-auto w-full gap-4">
      <div className="absolute flex font-bold lg:text-2xl text-sm lg:-top-20 lg:left-20 -top-10 left-5">
        TRUSTED BY
